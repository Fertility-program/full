    ...
    <footer className="mt-auto border-t border-[#f0e3e8]/50" role="contentinfo">
      <div className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#a8ddd5] to-[#5ba89d] flex items-center justify-center">
                <span className="text-white text-xs font-bold">V</span>
              </div>
              <span className="text-xl font-semibold text-[#3d8a7d]">
                Veronica Bloom
              </span>
            </div>
            <p className="text-sm text-[#5a7570] leading-relaxed">
              The complete fertility wellness program: cycle-synced exercises, fertility
              nutrition and supplement guidance for women on their conception journey.
            </p>
          </div>
          ...
          <div>
            ...
            <nav aria-label="Legal links" className="flex flex-col gap-2">
              ...
              <a
                href="https://instagram.com/veronica_bloom_fertility"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-[#5a7570] hover:text-[#5ba89d] transition-colors flex items-center gap-1.5"
              >
        ...
        <div className="mt-8 pt-6 border-t border-[#f0e3e8]/50 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[#6aab9f]">
            © {new Date().getFullYear()} Veronica Bloom. All rights reserved.
          </p>
          <div className="flex items-center gap-3">
            <span className="text-[9px] text-[#4a7a70]">Scan to get the app:</span>
            <img
              src="https://api.qrserver.com/v1/create-qr-code/?size=60x60&data=https://veronica-program.vercel.app/download&color=2d5a52&bgcolor=ffffff"
              alt="QR code"
              width={60}
              height={60}
              className="rounded-lg border border-[#c2ddd8]"
            />
          </div>
        </div>

        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-3 flex items-center justify-between gap-4">
          ...
          <Link href="/" className="flex items-center gap-2 shrink-0">
            ...
            <div className="hidden sm:block">
              <div className="text-xl font-semibold leading-none tracking-tight text-[#3d8a7d]">
                Veronica Bloom
              </div>
              <div className="text-[8px] uppercase tracking-[0.25em] text-[#6aab9f] mt-0.5">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="p-2 rounded-xl hover:bg-[#f0faf8] transition-colors"
              aria-label="Instagram"
            >
              <svg className="w-5 h-5 text-[#6aab9f]" fill="currentColor" viewBox="0 0 24 24">

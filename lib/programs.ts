...
const REST_DAYS: RestDayContent[] = [
  {
    ...
    selfCareTips: [
      "Take a warm bath with epsom salts (magnesium supports progesterone)",
      "Drink an extra glass of water with lemon today",
      "Go for a gentle 15-minute walk in nature",
      "Apply body lotion mindfully — connect with your body",
    ],
    affirmation: "I am nourishing my body and creating space for new life. Rest is part of my strength.",
  },
  {
    title: "Nourish & Renew",
    ...
    selfCareTips: [
      "Prepare tomorrow's breakfast tonight (overnight oats are perfect for fertility)",
  ...
  },
  {
    ...
    meditation: {
      title: "Womb Visualization",
      duration: "7 min",
      instructions: [
        "Sit or lie comfortably. Place hands gently on your lower belly.",
        "Breathe deeply, sending warmth to your reproductive space.",
        "Visualize a warm, golden light filling your pelvis.",
        "With each breath, imagine this light nourishing and healing.",
        "Feel gratitude for your body's wisdom and capability.",
        "Stay here for 3 minutes, breathing naturally.",
        "Finish with 5 normal breaths, eyes closed.",
      ],
    },
    journalPrompt: "What has improved the most? What still needs attention and patience?",
    selfCareTips: [
      "Try a cup of red raspberry leaf or chamomile tea this evening",
      "Do 5 minutes of gentle hip openers",
      "Spend 10 minutes doing something purely for pleasure (reading, music, garden)",
      "Lay on the floor with legs up the wall for 5 minutes (great for pelvic circulation)",
    ],
    affirmation: "I am patient with my body. My journey is unfolding perfectly in its own time.",
  },
  {
    ...
    meditation: {
      ...
      instructions: [
        ...
        "Breathe again. Say: 'May I trust my body's wisdom.'",
    ...
    selfCareTips: [
      "Take progress photos or journal about how you feel (optional, no pressure)",
      "Cook your favorite fertility-friendly meal today — make it special",
  ...
  },
  {
    ...
    selfCareTips: [
      "Go to bed 30 minutes earlier tonight — sleep supports hormone production",
    ...
    affirmation: "Rest is not laziness. It is the foundation of my fertility.",
  },
  {
    ...
    meditation: {
      ...
      instructions: [
        ...
        "Finally, expand to all beings: 'May all women on this journey be supported.'",
